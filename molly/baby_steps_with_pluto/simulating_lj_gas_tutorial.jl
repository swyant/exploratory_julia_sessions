...
# ╔═╡ 57bea846-b853-11ed-1c71-df36f7019138
using Molly

# ╔═╡ 477200b5-2b4d-4dc2-aaed-adcc886553c3
using GLMakie

# ╔═╡ ad812c75-b272-4f54-994d-849a9f879d94
begin
	n_atoms = 200
	mass   = 15.0u"u"
...
# ╔═╡ d11777b7-ae75-4378-8a92-63e7acdbac8d
begin
	boundary = CubicBoundary(4.0u"nm", 4.0u"nm", 4.0u"nm")
	coords   = place_atoms(n_atoms, boundary; min_dist=0.3u"nm")
end

# ╔═╡ 00d0ed8f-e561-4375-929c-b8e2f1a4e009
begin 
	temp       = 50.0u"K"
	velocities = [velocity(mass,temp) for i in 1:n_atoms] # sample from M-B dist
end

# ╔═╡ c5fad90b-8d98-4438-a8c4-62cd079838d1
pairwise_inters = (LennardJones(),)

# ╔═╡ 5fa7bf5f-7921-4cca-951a-c399eb43cefb
sys = System(
	atoms     		= atoms,
...
md"So the next little bit here was wrong, and it took me a long time to figure out how to slice a vector of staticarrays"

# ╔═╡ 6b57f6f0-415b-4a4e-a280-fe687a9498e8
begin
	atom1Traj = sys.loggers.coords.history[1] 
	atom2Traj = sys.loggers.coords.history[2]
